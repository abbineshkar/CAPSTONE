"""FedAvg strategy with metric logging and checkpoint tracking.

Flower's standard simulation loop is allowed to complete its configured number
of rounds. The strategy detects a validation plateau, records the best round,
and stores both the latest and best aggregated parameter sets for final testing.
"""
