"""Deterministic Non-IID partitioning for the 20-experiment study.

Strategies:
  1. Label skew: Dirichlet(alpha), with alpha in {100, 0.5, 0.1}
  2. Feature skew: phishing messages partitioned by text-length bands
  3. Quantity heterogeneity: 60/20/8/6/6 percent split with class balance

The Dirichlet routine resamples until every client has at least the configured
minimum number of examples. This keeps all five simulated clients active.
"""
