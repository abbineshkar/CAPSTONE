"""
export_client_splits.py
-----------------------
Export the exact deterministic client partition statistics for E1-E20
WITHOUT retraining any transformer models.

Outputs:
    results/client_splits/E1_client_split.csv
    ...
    results/client_splits/E20_client_split.csv
    results/client_splits/all_client_splits.csv
    results/client_splits/partition_summary.csv

Run from the project root:
    python export_client_splits.py
"""
