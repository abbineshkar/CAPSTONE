"""Memory-efficient sequential federated runner for experiments E1-E20.

This is the recommended runner for a 4 GB GPU. Clients train one at a time,
all begin each round from the same global checkpoint, and the best validation
checkpoint is restored before the final IID test evaluation.
